...
form.addEventListener('submit', e => {
  ...
  // .then(response => alert("Thank you!! I will get back to you soon."))
  .catch(error => console.error('Error!', error.message))
  document.querySelector(".backdrop").classList.add("showBackdrop");
...
document.getElementById("dismiss-popup-btn").addEventListener("click", function() {
  ...
  document.querySelector(".backdrop").classList.remove("showBackdrop");
});
